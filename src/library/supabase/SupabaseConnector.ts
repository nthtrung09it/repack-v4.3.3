...
export class SupabaseConnector implements PowerSyncBackendConnector {
  ...
  constructor(protected system: System) {
    ...
    console.log('Supabase Anon Key:', AppConfig.supabaseAnonKey);
    ...
    console.log('Supabase Client: --- after this.client constructor');
    this.storage = new SupabaseStorageAdapter({client: this.client});
    console.log('Supabase Client: --- after this.client constructor 222');
  }
  ...
  async login(username: string, password: string) {
    ...
    console.log('-------------- inside login finished');
    if (error) {
      throw error;
    }
  }
